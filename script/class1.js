...
// inline style 적영 되는 js css 명령어 활용
// 우선 순위가 가장 높아 다른 css  충동없이 우선적용할 수 있으나 css 속성이 여러개라면 개별명령을 해야해서 작성이 불편하고 효율이 안좋다
...
li[2].addEventListener('click',function(){
    this.classList.replace('design_set1','design_set1')
})
